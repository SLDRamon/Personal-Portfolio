            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                {/* Left Column */}
                    ...
                    <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                        ...
                        <p>
                            ...
                            building responsive and user-friendly website with a focus on creating intuitive, visually
                            appealing, and interactive user experiences.
                        </p>
                    </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    {highlights.map((item, idx) => (
                        ...
                        >
                            <div className="w-12 h-12 rounded-xl bg-priamry/10 flex items-center justify-center mb-4 hover:bg-primary/20">
