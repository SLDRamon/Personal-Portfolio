...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "ramonsoledad12@gmail.com",
    href: "mailto:ramonsoledad12@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+63 908 235 2456",
    href: "tel:+63 908 235 2456",
  },
  {
    icon: MapPin,
    label: "Location",
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    setSubmitStatus({tpye: null, message: ""});
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-100 text-white">
            ...
            <span className="font-serif italic font-normal text-secondary-foreground"> together</span>.
          </h2>
